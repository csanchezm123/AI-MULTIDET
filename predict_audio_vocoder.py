...
import yaml
from models.audio.VocodersArtifacts.model import RawNet
...
def main():
    ...
    # load model config
    dir_yaml = './models/audio/VocodersArtifacts/model_config_RawNet.yaml'
    ...
    with open(output_path+"/result_audio.txt", 'w') as file:
        file.write(str(result_binary[0]))
    file.close()
